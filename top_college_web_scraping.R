...
#get schools that tie
ties <- rankings[table_rank > 1]
#the polished rankings - add 'tie' to ranking if a tie
...
#get the tuitions of the schools
...
#the descriptions of the colleges
